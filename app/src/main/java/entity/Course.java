...
public class Course {
    ...
    @Ignore
    public Course(int id, String title, Date startDate, Date anticipatedEndDate, CourseStatus courseStatus, int termId, String note, String mentor) {
        this.id = id;
        this.title = title;
    ...
    @Ignore
    public Course(String title, Date startDate, Date anticipatedEndDate, CourseStatus courseStatus, int termId, String note, String mentor) {
        this.title = title;
        this.startDate = startDate;
        this.anticipatedEndDate = anticipatedEndDate;
        this.courseStatus = courseStatus;
